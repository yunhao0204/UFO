...
class DemostrationPrompter(BasicPrompter):
    """
    The DemostrationPrompter class is the prompter for the user demostration learning.
    """

    def __init__(self, is_visual: bool, prompt_template: str, example_prompt_template: str, api_prompt_template: str):
        """
        Initialize the DemostrationPrompter.
    ...
    def user_content_construction(self, demo_record: DemostrationRecord) -> list[dict]:
        """
        Construct the prompt for the user demostration record with following contents:
        1. Initial Application Screenshot if it is visual mode
        2. Agent Trajectory.
        3. User Request.
        :param demo_record: The demostration record.
        return: The prompt for the user demostration record.
        """
        ...
        # Get the total steps of the demostration record. And construct the agent trajectory.
