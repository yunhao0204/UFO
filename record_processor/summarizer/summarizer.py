...
class DemostrationSummarizer:
    ...
    def __init__(self, is_visual: bool, prompt_template: str, demostration_prompt_template: str, api_prompt_template: str):
        """
        Initialize the DemostrationSummarizer.
        ...
        self.demostration_prompt_template = demostration_prompt_template
        self.api_prompt_template = api_prompt_template

    def build_prompt(self, demo_record: DemostrationRecord) -> list:
        """
        Build the prompt by the user demostration record.
        :param demo_record: The user demostration record.
        return: The prompt.
        """
        demostration_prompter = DemostrationPrompter(
            self.is_visual, self.prompt_template, self.demostration_prompt_template, self.api_prompt_template)
        demostration_system_prompt = demostration_prompter.system_prompt_construction()
        demostration_user_prompt = demostration_prompter.user_content_construction(
            demo_record)
        demostration_prompt = demostration_prompter.prompt_construction(
            demostration_system_prompt, demostration_user_prompt)
